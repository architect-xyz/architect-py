...
from architect_py.grpc_client.grpc_server import add_CptyServicer_to_server, CptyServicer, add_OrderflowServicer_to_server, OrderflowServicer
...
class MockCptyServicer(CptyServicer, OrderflowServicer):
    def Cpty(self, request_iterator, context):
        ...
        # send symbology
        yield Symbology(execution_info={
            "FOO Crypto/USD": {
                "MOCK": {
