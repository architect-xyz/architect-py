...
class AccountStatistics(Struct, omit_defaults=True):
    ...
    def __str__(self) -> str:
        return f"AccountStatistics(available_margin={self.available_margin},cash_excess={self.cash_excess},equity={self.equity},excess_liquidity={self.excess_liquidity},position_margin={self.position_margin},realized_pnl={self.realized_pnl},total_margin={self.total_margin},unrealized_pnl={self.unrealized_pnl},yesterday_equity={self.yesterday_equity})"
