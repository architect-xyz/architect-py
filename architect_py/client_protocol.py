...
class AsyncClientProtocol:
    ...
    @staticmethod
    def connect(*, api_key: str, api_secret: str, host: str = 'app.architect.co', paper_trading: bool = True, grpc_endpoint: str = 'cme.marketdata.architect.co', _port: Optional[int] = None, **kwargs: Any) -> AsyncClient: ...
