...
class AsyncClientProtocol:
    ...
    def get_market_snapshot(self, symbol: TradableProduct | str, venue: str) -> MarketTickerFields: ...
    def get_market_snapshots(self, symbols: list[TradableProduct | str], venue: str) -> Sequence[MarketTickerFields]: ...
    ...
    def send_limit_order(self, *, id: Optional[str] = None, symbol: TradableProduct | str, execution_venue: Optional[str], odir: OrderDir, quantity: Decimal, limit_price: Decimal, order_type: OrderType = OrderType.LIMIT, time_in_force: TimeInForce = TimeInForce.DAY, good_til_date: Optional[datetime] = None, price_round_method: Optional[TickRoundMethod] = None, account: Optional[str] = None, trader: Optional[str] = None, post_only: bool = False, trigger_price: Optional[Decimal] = None) -> OrderFields: ...
    def send_market_pro_order(self, *, id: Optional[str] = None, symbol: TradableProduct | str, execution_venue: str, odir: OrderDir, quantity: Decimal, time_in_force: TimeInForce = TimeInForce.DAY, account: Optional[str] = None, fraction_through_market: Decimal = Decimal('0.001')) -> OrderFields: ...
