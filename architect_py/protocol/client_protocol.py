...
class AsyncClientProtocol:
    ...
    def get_open_orders(self, venue: Optional[str], account: Optional[str], trader: Optional[str], symbol: Optional[str], parent_order_id: Optional[str], order_ids: list[str]) -> Sequence[OrderFields]: ...
