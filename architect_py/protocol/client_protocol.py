...
class AsyncClientProtocol:
    ...
    def get_cme_first_notice_date(self: Any, market_id: str) -> Optional[date]: ...
    ...
    def send_market_pro_order(self: Any, *, market: str, odir: OrderDir, quantity: Decimal, time_in_force_instruction: CreateTimeInForceInstruction = CreateTimeInForceInstruction.DAY, account: Optional[str] = None, source: OrderSource = OrderSource.API, fraction_through_market: Decimal = Decimal(0.0200000000000000004163336342344337026588618755340576171875)) -> Optional[GetOrderOrder]: ...
