...
class AsyncClientProtocol:
    ...
    def get_account_query(self, id: Union[UUID, None, UnsetType] = UNSET, name: Union[str, None, UnsetType] = UNSET, **kwargs: Any) -> GetAccountQueryUser: ...
    def get_account_summaries(self, accounts: list[str], venue: Optional[str] = None, trader: Optional[str] = None) -> Sequence[AccountSummaryFields]: ...
    ...
    def get_historical_orders_query(self, order_ids: Union[list[str], None, UnsetType] = UNSET, venue: Union[str, None, UnsetType] = UNSET, account: Union[str, None, UnsetType] = UNSET, parent_order_id: Union[str, None, UnsetType] = UNSET, from_inclusive: Union[datetime, None, UnsetType] = UNSET, to_exclusive: Union[datetime, None, UnsetType] = UNSET, **kwargs: Any) -> GetHistoricalOrdersQueryFolio: ...
    def get_l3_book_snapshot(self, symbol: str) -> L3BookSnapshot: ...
    def get_l_2_book_snapshot_query(self, symbol: str, venue: Union[str, None, UnsetType] = UNSET, **kwargs: Any) -> GetL2BookSnapshotQueryMarketdata: ...
    def get_market_snapshot_query(self, symbol: str, venue: Union[str, None, UnsetType] = UNSET, **kwargs: Any) -> GetMarketSnapshotQueryMarketdata: ...
    ...
    def get_market_status_query(self, symbol: str, venue: Union[str, None, UnsetType] = UNSET, **kwargs: Any) -> GetMarketStatusQueryMarketdata: ...
    ...
    def l1_book_snapshot(self, symbol: str, venue: str) -> MarketTickerFields: ...
    ...
    def search_symbols(self, search_string: Optional[str] = None, execution_venue: Optional[str] = None) -> list[str]: ...
    def search_symbols_query(self, search_string: Union[str, None, UnsetType] = UNSET, execution_venue: Union[str, None, UnsetType] = UNSET, **kwargs: Any) -> SearchSymbolsQuerySymbology: ...
