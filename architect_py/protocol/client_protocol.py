...
class AsyncClientProtocol:
    ...
    def get_market_snapshot(self, symbol: str, venue: str) -> MarketTickerFields: ...
    def get_market_snapshots(self, symbols: list[str], venue: str) -> Sequence[MarketTickerFields]: ...
