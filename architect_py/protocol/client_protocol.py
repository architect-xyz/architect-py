...
class AsyncClientProtocol:
    ...
    def get_open_orders(self: Any, venue: Union[str, NoneType, UnsetType] = UNSET, account: Union[str, NoneType, UnsetType] = UNSET, trader: Union[str, NoneType, UnsetType] = UNSET, symbol: Union[str, NoneType, UnsetType] = UNSET, parent_order_id: Union[str, NoneType, UnsetType] = UNSET, order_ids: Union[list[str], NoneType, UnsetType] = UNSET, **kwargs: Any) -> GetOpenOrdersOms: ...
    ...
    def search_symbols(self: Any, *, execution_venue: str | None | architect_py.graphql_client.base_model.UnsetType = UNSET, marketdata_venue: str | None | architect_py.graphql_client.base_model.UnsetType = UNSET, underlying: str | None | architect_py.graphql_client.base_model.UnsetType = UNSET, max_results: int | None | architect_py.graphql_client.base_model.UnsetType = UNSET, results_offset: int | None | architect_py.graphql_client.base_model.UnsetType = UNSET, search_string: str | None | architect_py.graphql_client.base_model.UnsetType = UNSET, sort_by_volume_desc: bool | None | architect_py.graphql_client.base_model.UnsetType = UNSET, glob: str | None = None, regex: str | None = None, **kwargs: Any) -> list[str]: ...
    ...
    def send_market_pro_order(self: Any, *, symbol: str, marketdata_venue: Optional[str] = None, odir: OrderDir, quantity: Decimal, time_in_force: TimeInForce = TimeInForce.DAY, account: Optional[str] = None, fraction_through_market: Decimal = Decimal('0.001')) -> OrderFields: ...
