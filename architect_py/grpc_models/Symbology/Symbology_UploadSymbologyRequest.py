...
#   filename:  Symbology_UploadSymbologyRequest.json
...
class UploadSymbologyRequest(Struct):
    execution_info: Dict[str, Dict[str, ExecutionInfo]] | None = None
    options_series: Dict[str, OptionsSeriesInfo] | None = None
    product_aliases: Dict[str, Dict[str, str]] | None = None
    products: Dict[str, ProductInfo] | None = None
