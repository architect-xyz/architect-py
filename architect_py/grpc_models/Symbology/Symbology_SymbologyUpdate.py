...
#   filename:  Symbology_SymbologyUpdate.json
...
class ProductType11(Struct):
    derivative_kind: DerivativeKind1 | DerivativeKind2 | DerivativeKind3
    expiration: str
    multiplier: str
...
class ExecutionInfo(Struct):
    ...
    min_order_quantity_unit: MinOrderQuantityUnit1 | MinOrderQuantityUnit2
    step_size: str
    tick_size: TickSize1 | TickSize2
...
class OptionsSeriesInfo(Struct):
    ...
    options_series: str
    quote_symbol: str
    strikes_by_expiration: Dict[str, List[str]]
    underlying: str
    venue_discriminant: str | None = None
...
class ProductType19(Struct):
    instance: EventContractSeriesInstance1 | EventContractSeriesInstance2
...
class SnapshotOrUpdateForAliasKindAndSnapshotOrUpdateForStringAndString1(Struct):
    snapshot: Dict[
        str, SnapshotOrUpdateForStringAndString1 | SnapshotOrUpdateForStringAndString2
    ]
...
Update1 = List[str | ExecutionInfo] | None
...
Update2 = List[str | OptionsSeriesInfo] | None
...
Update3 = List[str | ProductInfo] | None
