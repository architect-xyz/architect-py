...
#   filename:  CreateAlgoOrderRequestforTwapAlgo.json
...
class CreateAlgoOrderRequestForTwapAlgo(Struct):
    ...
    @staticmethod
    def create_stub(channel: grpc.aio.Channel) -> grpc.aio.UnaryUnaryMultiCallable["CreateAlgoOrderRequestforTwapAlgo", AlgoOrder_for_TwapAlgo]:
